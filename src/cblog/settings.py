...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonedb.crh32bhluadm.us-west-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogbucket12345' # please enter your s3 bucket name
AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME
AWS_S3_REGION_NAME = "us-west-1" # please enter your s3 region 
